...
$result1 = mysqli_query($connect, "SELECT kode,nama_akun,saldo,saldo_akhir,laporan_neraca FROM data_chartofaccount WHERE laporan_neraca=1 ORDER BY laporan_neraca ASC"); 
$result2 = mysqli_query($connect, "SELECT kode,nama_akun,saldo,saldo_akhir,laporan_neraca FROM data_chartofaccount WHERE laporan_neraca=2 OR laporan_neraca=3 ORDER BY laporan_neraca ASC"); 
?>
...
<head>
  ...
  <title>SIKOP | Laporan Neraca</title>
		      ...
		      <ul class="sidebar-menu" data-widget="tree">
		        ...
		        <li class="active treeview">
		          ...
		          <ul class="treeview-menu">
		            ...
		            <li class="active"><a href="perhitungan_hasil_usaha.php"><i class="fa fa-circle-o"></i> Laporan Neraca</a></li>
		          </ul>
		        </li>
		        <li class="treeview">
		          <a href="#">
		    		...
		    		<div class="col-xs-12">
				          <div class="box">
				            <div class="box-header with-border">
				              <h3 class="box-title">Tabel Aktiva</h3>
				            </div>
				            <!-- /.box-header -->
				            <div class="box-body">
				          ...
				          <div class="box">
				            <div class="box-header with-border">
				              <h3 class="box-title">Tabel Kewajiban dan Ekuitas</h3>
				            </div>
				            <!-- /.box-header -->
				            <div class="box-body">
				              <table class="table table-bordered">
				                <tbody>
				                	<tr>
					                  <th style="width: 10px">#</th>
					                  <th style="width: 70%">Kewajiban & Ekuitas</th>
						              <th>Jumlah</th> 
					                </tr>
				                <tr>
				                	<?php
