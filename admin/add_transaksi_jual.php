...
$list_barang = mysqli_query($connect, "SELECT nama,jenis_barang FROM data_koperasi ORDER BY id ");
		      ...
		      <ul class="sidebar-menu" data-widget="tree">
		        ...
		        <li class="active treeview">
		          ...
		          <ul class="treeview-menu">
		            ...
		            <li class="active"><a href="add_transaksi_jual.php"><i class="fa fa-circle-o"></i> Penjualan</a></li>
		          </ul>
		        </li>
		        <li>
					...
					<div class="col-xs-12">							
						<div class="box">
				            ...
				            <!-- form start -->
				              ...
				              <div class="box-body">
				              	<form action="proses_penjualan.php" class="form-horizontal" method="post" name="form1">
					                ...
					                <label>Harga Jual <small>*per pcs/unit/buah</small></label>
					                <div class="form-group">
					                  <div class="col-sm-10">
					                    <input type="text" class="form-control" placeholder="0" name="harga_jual">
					                  </div>
					                </div> 
