		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="row">
					...
					<div class="col-xs-12">						
					<a href="list_coa.php"><button name="update" type="submit" class="btn btn-info">Kembali ke CoA</button></a>	
						<div class="box">
							<!-- Horizontal Form -->
				            ...
				            <!-- form start -->
				              ...
				              <div class="box-body">
				              	<form action="proses_coa.php" class="form-horizontal" method="post" name="form1">
					              	<label>Nama Akun</label>
					                <div class="form-group">
					                  <div class="col-sm-10">
					                  	<input type="hidden" class="form-control" placeholder="Masukkan keterangan" name="id">
				                  		<input type="text" class="form-control" placeholder="Masukkan keterangan" name="nama_akun">
					                  </div>
					                </div>
					                <label>Kode</label>
					                <div class="form-group">
					                  <div class="col-sm-10">
					                    <input type="text" class="form-control" placeholder="0" name="kode">
					                  </div>
					                </div> 
