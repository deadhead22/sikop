...
$result = mysqli_query($connect, "SELECT * FROM data_chartofaccount ORDER BY id_akun ASC");

$select = $connect->prepare("SELECT COUNT(id_akun) FROM data_chartofaccount");
$select->execute();
$select->store_result();
$select->bind_result($count_coa);
$select->fetch();
?>
...
<head>
  ...
  <title>SIKOP | Chart of Account</title>
		    ...
		    <section class="content">
		    	<div class="row">
			        <div class="col-md-3 col-sm-6 col-xs-12">
			          ...
			          <a href="add_coa.php"><button name="update" type="submit" class="btn btn-primary">Tambah Akun</button></a>
			          <!-- /.info-box -->
			        </div>
			        <!-- /.col -->
			        <div class="col-md-3 col-sm-6 col-xs-12">
				            ...
				            <div class="box-body table-responsive no-padding">
				              <table id="example1" class="table table-bordered table-striped">
							    ...
							    while($user_data = mysqli_fetch_array($result)) {							    	
							        ...
							        echo "<td><a href='edit.php?id=$user_data[id_akun]'>Edit</a> | <a href='delete_coa.php?id=$user_data[id_akun]'>Delete</a></td></tr>";
							        ++$number;        
							    }
							    ?>
							    </tbody>
