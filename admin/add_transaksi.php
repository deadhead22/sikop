...
<head>
  ...
  <title>SIKOP | Tambah Transaksi</title>
					...
					<div class="col-xs-12">							
						<div class="box">
				            ...
				            <!-- form start -->
				              ...
				              <div class="box-body">
				              	<form id="add_form" action="proses_transaksi.php" class="form-horizontal" method="post" name="form1">
					              	<label>Deskripsi Transaksi</label>
					                <div class="form-group">
					                  <div class="col-sm-10">
					                  	<input type="hidden" class="form-control" placeholder="Masukkan keterangan" name="id">
				                  		<input id="name" type="text" class="form-control" placeholder="Masukkan keterangan" name="transaksi">
					                  </div>
					                </div>
					                <label>Tanggal</label>
					                <div class="form-group">
					                ...
					                <div class="form-group">
					                  <div class="col-sm-10">
					                    <input type="text" class="form-control" placeholder="0" name="jumlah">
					                  </div>
					                </div>
