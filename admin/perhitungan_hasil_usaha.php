...
$result = mysqli_query($connect, "SELECT kode,nama_akun,saldo_akhir,phu FROM data_chartofaccount WHERE phu=1 OR phu=2 OR phu=3 ORDER BY phu ASC"); 
?>
		      ...
		      <ul class="sidebar-menu" data-widget="tree">
		        ...
		        <li class="active treeview">
		          ...
		          <ul class="treeview-menu">
		            ...
		            <li class="active"><a href="perhitungan_hasil_usaha.php"><i class="fa fa-circle-o"></i> Perhitungan Hasil Usaha (PHU)</a></li>
				...
				<div class="row">
			        ...
			        <div class="col-xs-12">
				            ...
				            <div class="box-header">
				              <h3 class="box-title">Tabel Perhitungan Hasil Usaha</h3> 
				            </div>
			            	<!-- /.box-header -->
				            ...
				            <div class="box-body table-responsive no-padding">
				              <table id="example1" class="table table-bordered table-striped">
							    ...
							    <tfoot>
							    	<th>
							    		<form id="update_shu" action="proses_shu.php" class="form-horizontal" method="post" name="updateshu">
							    			<input type="hidden" class="form-control" value="<?php echo $shu ?>" name="shu">
											<button name="Submit" type="submit" class="btn btn-info pull-left">Update SHU</button>
										</form>
							    	</th>
