		      ...
		      <ul class="sidebar-menu" data-widget="tree">
		        ...
		        <li class="active treeview">
		          ...
		          <ul class="treeview-menu">
		            ...
		            <li class="active"><a href="add_transaksi_beli.php"><i class="fa fa-circle-o"></i> Pembelian</a></li>
					...
					<div class="col-xs-12">							
						<div class="box">
				            ...
				            <!-- form start -->
				              ...
				              <div class="box-body">
				              	<form action="proses_pembelian.php" class="form-horizontal" method="post" name="form1">
					              	<label>Deskripsi Pembelian</label>
					                <div class="form-group">
					                  <div class="col-sm-10">
					                  	<input type="hidden" class="form-control" name="id">
				                  		<input type="text" class="form-control" placeholder="Masukkan keterangan" name="transaksi">
					                  </div>
					                </div>
					                <label>Tanggal</label>
					                <div class="form-group">
					                ...
					                <div class="form-group">
					                  <div class="col-sm-10">
					                    <input type="text" class="form-control" placeholder=" " name="jenis_barang">
					                  </div>
					                </div> 
					                <label>Harga Beli <small>*per pcs/unit/buah</small></label>
					                <div class="form-group">
					                  <div class="col-sm-10">
					                    <input type="text" class="form-control" placeholder="0" name="harga_beli">
					                    <input type="hidden" class="form-control" placeholder="0" name="harga_pokok">
					                  </div>
					                </div> 
